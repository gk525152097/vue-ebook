  ...
  <div class="menu-bar">
    <transition name="slide-up">
      <div class="menu-wrapper" v-show="ifTitleAndMenuShow" :class="{'hide-box-shadow': ifSettingShow || !ifTitleAndMenuShow}">
        ...
        <div class="icon-wrapper">
          <span class="icon-equalizer icon" @click="ShowSetting(2)"></span>
        </div>
        <div class="icon-wrapper">
      ...
      <div class="setting-wrapper" v-show="ifSettingShow">
        ...
        <div class="setting-progress" v-else-if="showTag === 2">
          <div class="progress-wrapper">
            <input type="range" max="100" min="0" step="1" class="progress" @change="onProgressChange($event.target.value)" @input="onProgressInput($event.target.value)" :value="progress" :disabled="!bookAvailable" ref="progress">
          </div>
